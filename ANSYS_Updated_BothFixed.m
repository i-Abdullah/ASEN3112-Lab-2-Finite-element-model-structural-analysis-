...
type_support = 'E = 69 GPa, both sides fixed';
...
addpath('./Updated ANSYS Results/BothFixed'); % add ansys files to path,

Internal_force_filename = 'forces_E_69.csv';
%Reaction_force_filename = 'reac_forces_E_70_A_increased_hollow_nodes_displaced.csv';
Displacement_filename = 'disp_E_69.csv';
